                        ...
                        <div class="col-xl-12 col-lg-8 col-md-8 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <table class="table table-hover">
                                  <thead>
                                      <tr>
                                          <th scope="col" rowspan="1" colspan="1" style="width:20 px ;">#</th>
                                          <th scope="col" rowspan="1" colspan="1" style="width:20 px ;">Category ID</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Category name</th>
      ...
      <div class="modal-body">
        ...
        <form>
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="M" id="categoryName">
          </div>
          <div class="form-group">
            <label for="categoryID">Category Name</label>
            <input type="text" class="form-control" value="Male" id="categoryID">
          </div>
