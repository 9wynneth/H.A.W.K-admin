...
<script src="https://cdn.jsdelivr.net/npm/datetimepicker/dist/jquery.datetimepicker.full.min.js"></script>
    ...
    <title>Table - Order Detail</title>
        <!-- favicon -->
                                ...
                                <table class="table table-hover">
                                  <thead>
                                      <tr>
                                          ...
                                          <th scope="col" rowspan="1" colspan="1" style="width: 10%;">Order Detail ID</th>
                                          <th scope="col" rowspan="1" colspan="1" style="width: 5%;">Product ID</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editModalLabel">Edit Order Detail</h5>
      ...
      <div class="modal-body">
        ...
        <form>
          <div class="form-group">
            <label for="shipperID">Order Detail ID</label>
            <input type="text" class="form-control" value="2" id="categoryName">
          </div>
          <div class="form-group">
            <label for="shipperName">Product ID</label>
            <input type="text" class="form-control" value="PF002" id="categoryID">
          </div>
          <div class="form-group">
            <label for="shipperName">Order ID</label>
            <input type="text" class="form-control" value="2023042600002" id="categoryID">
          </div>
          <div class="form-group">
            <label for="shipperName">Price</label>
            <input type="number" class="form-control" value="350000" id="categoryID">
          </div>
          <div class="form-group">
            <label for="shipperName">Qty</label>
            <input type="number" class="form-control" value="1" id="categoryID">
          </div>
          <div class="form-group">
      ...
      <div class="modal-footer">
        ...
        <button type="button" data-toggle="modal" data-target="#sucessful"class="btn btn-primary " id="btnRegister"><span class="d-flex align-items-center" class="d-flex align-items-center text-center">Save change</span></button>
        <div class="modal fade" id="successful" tabindex="-1" role="dialog" aria-labelledby="successfulLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="successfulLabel">Success!</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
        ...
        <button type="button" class="btn btn-danger" id="confirmDeleteButton">Delete</button>
                                ...
                                <div class="modal fade" id="addProductModal" tabindex="-1" role="dialog" aria-labelledby="addProductModalLabel" aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <h5 class="modal-title" id="addProductModalLabel">Add New Order Detail</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                          <span aria-hidden="true">&times;</span>
                                        </button>
                                      </div>
                                      <div class="modal-body">
                                        ...
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" value="" id="productId" placeholder="Product ID">
                                              </div>
                                              <div class="form-group">
                                                <label for="productDesc">Order ID</label>
                                                <input type="text" class="form-control" id="productDesc" placeholder="Order ID">
                                              </div>
                                              <div class="form-group">
                                                <label for="productColor">Price</label>
                                                <input type="number" class="form-control" id="productColor" placeholder="Price">
                                              </div>
                                              <div class="form-group">
...
$(document).ready(function() {
  ...
  function saveChanges() {
    $('#editModal').modal('hide'); // Close the editModal
    $('#successful').modal('show'); // Show the successful modal
  }

  // Add an event listener to the Save Change button
