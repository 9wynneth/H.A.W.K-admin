                        ...
                        <div class="col-xl-12 col-lg-8 col-md-8 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <table class="table table-hover">
                                  <thead>
                                      <tr>
                                          <th scope="col" rowspan="1" colspan="1" style="">#</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Product ID</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Product name</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Description</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Category</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Brand</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Color</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Pic</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Qty</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Price</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Anti-radiasi</th>
                                  ...
                                  <tbody>
                                      <tr>
                                          <th scope="row">1</th>
                                          <td>PM001</td>
                                          <td>Ray-Ban RB6503D 2509 s55</td>
                                          <td>W= 55 mm <br>
                                            B = 18 mm <br>
                                            H = 50 mm <br>
                                            L = 145 mm <br>
                                          ...
                                          <td>Ray-Ban</td>
                                          <td>Black</td>
                                          <td><img src="../assets/images/Ray-Ban RB6503D 2509 s55.jpg" style="width: 60px;"></td>
                                          <td>10</td>
                                          <td>Rp 1.700.000</td>
                                          <td>No</td>
                                          <td>
                                      ...
                                      <tr>
                                        <th scope="row">2</th>
                                        <td>PM002</td>
                                        <td>Oakley Sway Bar 0.5 Satin Bar (OX5076-01) s56</td>
                                        <td>W= 56 mm <br>
                                          B = 16 mm <br>
                                          H = 36 mm <br>
                                          L = 136 mm <br>
                                          M = <span style="font-size: 11px;" > Titanium</span></td>
                                        <td>Male</td>
                                        <td>Oakley</td>
                                        <td>Black</td>
                                        <td><img src="../assets/images/(OX5076-01) s56.jpg" style="width: 60px;"></td>
                                        <td>5</td>
                                        <td>Rp 3.200.000</td>
                                        <td>No</td>
                                        <td>
                                      ...
                                      <tr>
                                          <th scope="row">3</th>
                                          <td>PF002</td>
                                          <td>Illustro F IB HIHE5236 C4 50</td>
                                          <td>W= 51 mm <br>
                                            B = 21 mm <br>
                                            H = 40 mm <br>
                                            L = 145 mm <br>
                                          ...
                                          <td>Illustro</td>
                                          <td>White</td>
                                          <td><img src="../assets/images/ILLUSTRO_PLASTIC_Frame_SQUARE_FIBHIHE5236C450_1100000066515-s.png" style="width: 60px;"></td>
                                          <td>10</td>
                                          <td>Rp 350.000</td>
                                          <td>Yes</td>
                                          <td>
                                      ...
                                      <tr>
                                        ...
                                        <td>Guess</td>
                                        <td>Silver</td>
                                        <td><img src="../assets/images/Guess F GE 2783 021 54.png" style="width: 60px;"></td>
                                        <td>5</td>
                                        <td>Rp 1.940.000</td>
                                        <td>No</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Gucci</td>
                                        <td>Gold</td>
                                        <td><img src="../assets/images/Gucci F GU K 1357OJ 004 48.png" style="width: 60px;"></td>
                                        <td>1</td>
                                        <td>Rp 10.370.000</td>
                                        <td>No</td>
                                        <td>
      ...
      <div class="modal-body">
        ...
        <form>
          <div class="form-group">
            <label for="shipperID">Product ID</label>
            <input type="text" class="form-control" value="T002" id="categoryName">
          </div>
          <div class="form-group">
            <label for="shipperName">Product Name</label>
            <input type="text" class="form-control" value="Ray-Ban RB6503D 2509 s55" id="categoryID">
          </div>
          <div class="form-group">
            <label for="shipperName">Description</label>
            <input type="text" class="form-control" value="W= 55 mm
            B = 18 mm
            H = 50 mm
            L = 145 mm
            M = Metal" id="categoryID">
          </div>
          <div class="form-group">
            <label for="shipperArea">Product Category</label>
            <select class="form-control" id="categoryID">
                <option value="Barat" selected>Male</option>
                <option value="Timur">Female</option>
                <option value="Selatan">Unisex</option>
              </select>
          </div>
          <div class="form-group">
            <label for="shipperName">Brand</label>
            <input type="text" class="form-control" value="Ray-Ban" id="categoryID">
          </div>
          <div class="form-group">
            <label for="shipperName">Color</label>
            <input type="text" class="form-control" value="Black" id="categoryID">
          </div>
          <div class="form-group">
            <label for="productImage">Upload Picture</label>
            <input type="file" class="form-control-file purple-browse" value="../assets/images/Ray-Ban RB6503D 2509 s55.jpg" id="Picture">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="productPrice" placeholder="1700000">
          </div>

          <div class="form-group">
            <label for="categoryId">Anti-radiasi</label>
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="productId" placeholder="Name">
                                              </div>
                                              <div class="form-group">
                                                <label for="productDesc">Product Description</label>
                                                <input type="text" class="form-control" id="productDesc" placeholder="Description">
                                              </div>
                                              <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                <label for="productImage">Upload Picture</label>
                                                <input type="file" class="form-control-file purple-browse" id="Picture">
                                              </div>
                                              <div class="form-group">
                                                <label for="productQuantity">Quantity</label>
                                                <input type="number" class="form-control" id="productQuantity" placeholder="Qty">
                                              </div>
                                              <div class="form-group">
                                                <label for="productPrice">Price</label>
