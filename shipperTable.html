                        ...
                        <div class="col-xl-12 col-lg-8 col-md-8 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <table class="table table-hover">
                                  <thead>
                                      <tr>
                                          <th scope="col" rowspan="1" colspan="1" style="width:10 px ;">#</th>
                                          <th scope="col" rowspan="1" colspan="1" style="width:20 px ;">Shipper ID</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Shipper name</th>
                                          <th scope="col" rowspan="1" colspan="1" style="width: 150px; padding-left: 5px;">Shipper area</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Shipper phone</th>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editModalLabel">Edit Shipper</h5>
      ...
      <div class="modal-body">
        ...
        <form>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" value="Tony" id="categoryID">
          </div>
          <div class="form-group">
            <label for="shipperArea">Shipper Area</label>
            <select class="form-control" id="categoryID">
                <option value="Barat" selected>Barat</option>
          ...
          <div class="form-group">
            <label for="shipperName">Shipper Phone</label>
            <input type="text" class="form-control" placeholder="084572642311" value="084572642311" id="shipperPhone" oninput="this.value = this.value.replace(/[^0-9]/g, '')" inputmode="numeric">
          </div>
        ...
        <button type="button" class="btn btn-danger" id="confirmDeleteButton">Delete</button>
                                ...
                                <div class="modal fade" id="addProductModal" tabindex="-1" role="dialog" aria-labelledby="addProductModalLabel" aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <h5 class="modal-title" id="addProductModalLabel">Add New Shipper</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                          <span aria-hidden="true">&times;</span>
                                        </button>
                                      </div>
                                      <div class="modal-body">
                                        ...
                                        <form>
                                          <div class="form-group">
                                            <label for="productId">Shipper Name</label>
                                            <input type="text" class="form-control" id="productId" placeholder="Name">
                                          </div>
                                          <div class="form-group">
                                            <label for="categoryId">Shipper Area</label>
                                            <select class="form-control" id="Area">
                                              ...
                                              <option value="5">Tengah</option>
                                              <!-- Add more options as needed -->
                                            </select>
                                          </div>
                                          <!-- Add more form fields for other product details -->
                                          <div class="form-group">
                                            <label for="productBrand">Shipper Phone</label>
                                            <input type="text" class="form-control" id="productBrand" placeholder="08xxxxxxxxxx">
                                          </div>
