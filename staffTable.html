                                ...
                                <table class="table table-hover">
                                  <thead>
                                      <tr>
                                          ...
                                          <th scope="col" rowspan="1" colspan="1" style="width:20 px ;">Staff ID</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Staff name</th>
                                          <th scope="col" rowspan="1" colspan="1" style="">Staff role</th>
      ...
      <div class="modal-body">
        ...
        <form>
          <div class="form-group">
            <label for="shipperID">Staff ID</label>
            <input type="text" class="form-control" value="J003" id="categoryName">
          </div>
          <div class="form-group">
            <label for="shipperName">Staff Name</label>
            <input type="text" class="form-control" value="Joko" id="categoryID">
          </div>
          <div class="form-group">
            <label for="shipperArea">Staff Role</label>
            <select class="form-control" id="categoryID">
                <option value="Barat" selected>Manager</option>
                <option value="Timur">Admin</option>
                <option value="Selatan">Staff</option>
              </select>
          </div>
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <form>
                                          <div class="form-group">
                                            <label for="productId">Staff Name</label>
                                            <input type="text" class="form-control" id="productId" placeholder="Name">
                                          </div>
                                          <div class="form-group">
                                            <label for="categoryId">Staff Role</label>
                                      ...
                                      <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                        <button type="button" onclick="success" id="btnSave" class="btn btn-primary">Save</button>
                                      </div>
                                    </div>
                                  </div>
                                </div>
